module.exports = {
    ...
    tip: {
      ...
      tokenSafeTip: "あなたの資産は、Nutoboxのアカウントではなく、{symbol}の​​公式クラウドローンパレットに直接ロックされます。",
    ...
    error: {
      ...
      tokenDeploying: "There's token in deploying,しばらく待つかページを更新してみてください。",
    ...
    np: {
      ...
      powerDownTip2: '{selectRatio} 週 | 毎{selectRatio} NP to 1 NUT',
