module.exports = {
    commen: {
      ...
      crowdstaking: "Staking (pertaruhan)",
      optional: "(opsional)",
      connectMetamask: 'Sambung ke Metamask',
      delegateFee: 'Fi delegasi',
      ...
      noData: 'Tiada data',
      pageNotFound: "Halaman tidak wujud！",
      ...
      nps: "Sistem Cadangan Penambahbaikan Nutbox",
      contract: "Kontrak",
    ...
    desc: {
      slogan: 'Membina ekonomi staking anda dengan cepat',
      featuredCommunity: 'Komuniti yang diketengahkan',
      aboutNutbox: 'Tentang Nutbox',
      totalValue: 'Jumlah nilai',
      disStrategy: 'Strategi pengedaran',
      adminOnly: 'Admin sahaja',
      youWillReceive: 'Anda akan dapat: ',
      iso: 'ISO: tawaran pertaruhan awal',
      isoDetail: 'Pertaruhkan token POS untuk melombong token komuniti. Kadar pulangan tinggi dan tiada risiko.',
      erc1155Desc: 'Pertaruhkan token ERC115 anda untuk melombong.',
      nutPower: 'Nut Power（NP）adalah kuasa pentadbiran demi Nutbox DAO. Ia dijana dengan pertaruhan NUT. Semakin lama masa buka kunci, semakin banyak NP yang anda akan dapat. Ia juga adalah hak anda untuk memperoleh NUT yang baru dihasil.',
      farming: 'Pertaruhkan token anda untuk melombong token komuniti',
    },
    operation: {
      withdraw: "Batalkan pertaruhan",
      harvest: "Menuai",
      approveContract: "Luluskan kontrak",
      approveCommunity: 'Luluskan komuniti',
      approvePool: 'Luluskan kolam',
      connectMetamask: "Sambing ke Metamask",
      change: 'Ubah',
      search: "Cari",
      userlogin: "Log masuk",
      ...
      enter: 'Masuk',
      approve: 'Luluskan',
      grant: 'Memberi kebenaran',
      manageCommunity: "Mengurus komuniti",
      exploreCommunity:'Terokai komuniti',
      save: 'Menyimpan',
      grantMintRole: 'Berikan kebenaran untuk Mint',
      configurePoolRatio: 'Konfigurasikan kolam pendelegasian',
      addDelegatePool: 'Menambah kolam pendelegasian',
      addPool: 'Menambah kolam',
      claim: 'Tuntutkan',
      recharge: "Cas semula",
      upgrade: 'Naik taraf'
    },
    wallet: {
      wallet: "Dompet",
      connectSteem: "Sambung ke dompet Steem",
      connectHive: "Sambung ke dompet Hive",
      connectCosmos: "Sambung ke dompet Keplr",
      install: "Pasang",
      transfer: "Memindah",
      asset: "Aset",
      nomination: "投票者",
    ...
    transaction: {
      broadcasting: "正在广播交易",
      inBlock: "交易已打包进区块",
      contributeOk: "Berjaya mengundi",
      withdrawOk: "提取成功",
      nominateOk: "投票成功",
      transactionOk: "Transaksi berjaya",
      depositOk: "Pertaruhan berjaya",
      withdrawOk: "取消质押成功",
      voteOk: 'Berjaya mengundi',
      unvoteOk: "Berjaya tarik undi",
    ...
    asset: {
      ...
      tokenId: "ID Token",
      wrongTokenId: "ID Token 必须是整数",
      price: "Harga",
      totalSupply: 'Jumlah bekalan',
      cap: 'Nilai pasaran',
      distributionAmount: "预挖量",
      notErc1155: "Ini bukan sesuatu token ERC1155."
    },
    treasury: {
      treasuryAddress: "Alamat Perbendaharaan",
      daoTreasury: "Perbendaharaan DAO",
      treasuryAsset: "Aset Perbendaharaan",
    ...
    opHistory: {
      ...
      create: "Membina komuniti",
      createWithName: "Membina komuniti",
      setFee: "调整DAO基金比例为：{amount}%",
      setFeeWithName: "调整DAO基金比例为：{amount}%",
      addPool: 'Kolam baru terbina: {pool}',
      addPoolWithName: 'Kolam baru terbina: {pool}',
      closePool: "Kolam tertutup: {pool}",
      closePoolWithName: "Kolam tertutup: {pool}",
      setRatio: "调整矿池比例",
      ...
      title: {
        ...
        ADMINCREATETREASURY: "Membina Perbendaharaan"
      }
    }
  };