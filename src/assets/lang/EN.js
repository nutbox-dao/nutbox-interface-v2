module.exports = {
  ...
  desc: {
    ...
    farming2: 'Just stake some tokens to earn. Operation will cost you 2.5% tokens as fee. 2% distributed to the community and 0.5% distributed to the Walnut platform.',
  ...
  pool: {
    ...
    creatTaxedPool: 'Create staking pool 2 on {chainName}',
