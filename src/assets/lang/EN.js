module.exports = {
  ...
  desc: {
    ...
    curation: 'Social Module can be added to reward user’s social contribution. ',
    curationP1: `When members create and curate content in a community, they receive its tokens.
    Token reward pools can be created for tweets, announcements, twitter space and discussion topics.)
    to the community on Wormhole3. A portion of Community Tokens can be allocated to the Social Module.
    Once the Social Module is set, your community will also be created on Wormhole3
    (<a href="https://alpha.womrhole3.io" target="_blank">https://alpha.womrhole3.io</a>),
    tokens will be automatically distributed to wallet of community members. To learn more about Wormhole3,
    see here (<a href="https://wormhole3.gitbook.io/wh3-cn/" target="_blank">https://wormhole3.gitbook.io/wh3-cn/</a>)`,
