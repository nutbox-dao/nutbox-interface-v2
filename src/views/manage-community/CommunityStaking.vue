      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="c-btn-group">
            <button
              class="primary-btn primary-btn-outline w-auto mr-2 px-3"
              style="height: 2rem"
              v-show="activePool.length > 1"
              @click="configPoolModal = true"
            >
              {{ $t("pool.updatePoolRatios") }}
            </button>
            <button
              class="primary-btn w-auto mx-0 d-flex align-items-center px-3"
              style="height: 2rem"
