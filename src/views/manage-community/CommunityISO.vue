  ...
  computed: {
    ...
    activeISOPool() {
      return this.activePool.filter(p => p.poolFactory.toLowerCase() !=
              getPoolFactoryAddress("erc20staking") && p.poolFactory.toLowerCase() != getPoolFactoryAddress('erc1155') && p.poolFactory.toLowerCase() != getPoolFactoryAddress('curation') && p.poolFactory.toLowerCase() != getPoolFactoryAddress('taxederc20staking'))
    },
    stakingPools() {
