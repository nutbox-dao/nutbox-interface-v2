...
export default {
  name: 'Crowdloan',
  components: { ManageStakingCard, StakingPoolType, StakingCrowdloanPool, StakingDelegatePool, StakingPoolConfig },
  data () {
    return {
  ...
  computed: {
    ...
    stakingPools() {
      switch(this.activeTab) {
        case 0:
          return this.activePool.filter(p => p.chainId == 0)
        case 1: 
