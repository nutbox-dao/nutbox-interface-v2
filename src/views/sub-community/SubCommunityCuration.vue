        ...
        <div class="cards-container">
          ...
          >
            <div
              ...
              :key="cardInfo.id"
            >
              <CommunityCurationCard :card="cardInfo" />
            </div>
          </div>
        </div>
      </template>
...
import CommunityCurationCard from "@/components/community/CommunityCurationCard";
...
export default {
  name: "SubCommunityCuration",
  components: { CommunityCurationCard },
  data() {
    return {
      activeTab: 0,
