        ...
        <div class="cards-container">
          <div class="cards-box cards-box-col3" :class="'col3-items-'+stakingCards.length">
            <div class="card-item" v-for="(cardInfo) of stakingCards" :key="cardInfo.id">
              <CommunityDappStakingCard :card="cardInfo"/>
            </div>
          </div>
        </div>
      </template>
...
import CommunityDappStakingCard from '@/components/community/CommunityDappStakingCard'
...
export default {
  ...
  components: { CommunityDappStakingCard },
  data () {
    return {
      activeTab: 0,
