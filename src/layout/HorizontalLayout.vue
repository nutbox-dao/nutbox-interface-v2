...
<template>
  <div class="page-layout">
    <p style="background-color: gray;margin-bottom:0;padding: .5rem;font-size:1.2rem;z-index:100">Under maintenance! Walnut will be put into use again after the upgrade, please stay tuned.</p>
