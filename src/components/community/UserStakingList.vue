<template>
    <div>
        ...
        <div class="d-flex px-3 justify-content-between align-items-center action-box" style="grid-area: action">
            ...
            <div v-b-toggle="'accordion'+pool.id" class="toggle-btn text-primary-0 font14">
        ...
        <div class="collapse-content-grid font16 py-3 px-4">
            ...
            <div>
                <div class="font-bold">{{ cToken ? cToken.symbol : '' }} Earned</div>
                <div class="font12">{{ pendingReward | amountForm }}</div>
            </div>
            <button class="primary-btn w-auto px-2 mx-0" @click="withdraw" :disabled="isWithdrawing">
...
export default {
    ...
    computed: {
        ...
        stakeToken() {
            ...
            const token = this.allTokens.filter(t => t.address.toLowerCase() == this.pool.asset)[0]
            return token
        },
        staked(){
