<template>
  <div class="multi-card">
    ...
    <div class="c-card border-0">
      ...
      <PoolOperationCrowdloan :card='card'/>
...
import PoolOperationCrowdloan from '@/components/community/PoolOperationCrowdloan'
...
export default {
  name: 'CommunityCrowdloanCard',
  components: {
    StakingHomeChainAssetModal,
    StakingCardHeader,
    PoolOperationCrowdloan
  },
  props: {
    card: {
      type: Object
